"""
Django settings for educonnect_api project.
"""
import os
...
INSTALLED_APPS = [
    'daphne',  # Pour WebSockets (doit être avant django.contrib.staticfiles)
...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='noreply@edulab.africa')

# API Spectacular (Documentation)
SPECTACULAR_SETTINGS = {
    'TITLE': 'EduLab Africa API',
    'DESCRIPTION': 'API REST pour la plateforme EduLab Africa - Initiative Hypee',
    'VERSION': '1.0.0',
...
BADGE_THRESHOLDS = {
    'FIRST_STEP': {'points': 0, 'action': 'first_question'},
    'CURIOUS': {'points': 100},
    'ENGAGED': {'points': 500},
    'EXPERT': {'points': 1000},
    'MASTER': {'points': 2500},
